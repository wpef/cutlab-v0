...
> Les retours fonctionnels et visuels remontés en recette manuelle (CHAT1-CHAT3, B3.1-B3.5) ont été déplacés vers `plans/PLAN_RECETTE.md` — priorité haute avant mise en prod.
